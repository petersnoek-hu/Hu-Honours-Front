        ...
        component: (
          <View className="flex-1">
            ...
            <Text className="text-xl text-white">
              Je maakt een korte presentatie bestaande uit vier foto's. Elke
              foto staat symbool voor een onderdeel van jouw verhaal. Je
              gebruikt geen tekst in je slides — jij bent degene die het verhaal
              vertelt.
            </Text>
          </View>
        ),
