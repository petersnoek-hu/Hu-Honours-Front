...
const level2Base = {
  ...
  steps: [
      ...
      component: (
        <View className="flex-1">
          <Text className="text-xl text-white mb-10">
            Iedereen heeft een uniek verhaal. Jij ook. In deze opdracht ga je
            jouw persoonlijke verhaal tot leven brengen — niet met lange
            teksten, maar met beelden en jouw eigen stem.
          </Text>
    ...
    },
    {
      ...
      component: (
        <View className="flex-1">
          <Text className="text-3xl text-white my-3">
            Binnen je presentatie
          </Text>
          ...
          <Text className="text-white my-2">
            Waar wil je deze cursus voor gebruiken of waarin wil jij je
            ontwikkelen?
          </Text>
        </View>
      ),
    },
    {
      ...
      component: (
        <View key={2} className="flex-1">
          <View
            className={`flex-row bg-blue h-[200] justify-around items-center p-5 mb-5 rounded-3xl`}
          >
      ...
      component: (
        <View className="flex-1 h-full justify-center items-center">
          ...
          <Text className="text-white">
            Je hebt de inleiding afgerond en de eerste stap gezet naar
            persoonlijk leiderschap. Goed bezig!
          </Text>
        </View>
      ),
    },
...
export default createLevel(level2Base, (features) => ({
  // Add any features if needed, for now it's an empty object
  // Example if you need to add features later:
  // upload: {
  //   handleUpload: features.upload?.handleUpload ?? (() => {}),
  //   files: features.upload?.files ?? []
  // }
}));
