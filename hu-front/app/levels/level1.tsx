...
const Level1 = () => {
  ...
  const { step, isLastStep, steps, currentStepIndex, back, next } =
    useMultiStepForm([
      <View key={0}>
        <Text className="text-white text-lg">
          Voordat je kunt groeien als leider, moet je jezelf leren begrijpen.
          Wat drijft jou? Hoe reageer je op de wereld om je heen? In deze eerste
          fase maak je kennis met de basisprincipes van persoonlijk leiderschap.
          Je ontdekt hoe je meer invloed kunt uitoefenen op je eigen leven —
          door bewust te kiezen hoe je denkt, voelt en handelt.
        </Text>
      </View>,
      <View key={1}>
      ...
      <View key={3} className="justify-center items-center">
        ...
        <Text className="text-white">
          ...
          verkennen van paradigma’s en principes van binnen naar buiten. Een
          mooie stap richting persoonlijk leiderschap. Goed bezig!
        </Text>
      </View>,
    ]);
    ...
    <SafeAreaView className="flex-1 pt-[40] px-[20] bg-[#333333]">
      <View className="w-full flex-1 bg-[#333333] relative">
        <LevelHeader
          ...
          barProgression={
            steps.length > 0 ? currentStepIndex / steps.length : 0
          }
          handleBackPress={() => {
